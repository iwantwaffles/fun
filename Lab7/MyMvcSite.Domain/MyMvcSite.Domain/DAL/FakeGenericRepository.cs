...
{
    public class FakeGenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : IEntityModels
    {
        List<TEntity> entities;

        public FakeGenericRepository(List<TEntity> entitiesList)
        {
