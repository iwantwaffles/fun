namespace MyMvcSite.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyMvcSite.DAL.MessageBoardContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"Migrations";
            ContextKey = "MyMvcSite.DAL.MessageBoardContext";
        }

        protected override void Seed(MyMvcSite.DAL.MessageBoardContext context)
        {
